...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
                ...
                <div id="accordion">
                    ...
                    <div>
                        <ul id="menu5">
                            ...
                            <? if ($userAuth->nivelAdmin->getIdAdmin() > 3)
                                echo "<li><a href='upload'>Subir</a></li>"; ?>
                        </ul>
                    </div>
                    ...
                    <div>
                        <ul id="menu3">
                            ...
                            <li><a href="historialCaratulas/listar" target="main">Listado</a></li>
                        </ul>
                    </div> 
                    ...
                    <? if ($userAuth->nivelAdmin->getIdAdmin() > 2) { ?>        
                        <h3><a href="#">Usuarios</a></h3><div>
                            <ul id="menu4"> 
                                <li><a href="userAdd" target="main">Alta</a></li>
                                <!--<li><a href="usuarios_1.php?act=editar" target="main">Editar</a></li>-->
                                <li><a href="userList" target="main">Listado</a></li> 
                            </ul></div><? } ?>
                </div>
        ...
        <script type="text/javascript">
            $("#right").load("main.php");
            $("#accordion div ul li a, #header div.welcome a.right").click(function () {
                $("#right")
